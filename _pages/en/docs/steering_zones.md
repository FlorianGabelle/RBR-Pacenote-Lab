...
type: doc
order: 40
cover: /assets/images/docs/en/configuration_window/steering_zones/steering_zones_numeric.png
sidebar:
  nav: docs-en
---
...
{% include image.html
   src="/assets/images/docs/en/configuration_window/steering_zones/first_zone.png"
   alt="First Zone"
   max_width="80%" %}
...
{% include image.html
   src="/assets/images/docs/en/configuration_window/steering_zones/second_zone.png"
   alt="Second Zone"
   max_width="80%" %}
...
{% include image.html
   src="/assets/images/docs/en/configuration_window/steering_zones/modifier.png"
